...
# Install this file at the top level of your Git repository
...
if [ "$NEWVERSION1" != "$NEWVERSION2" && "$NEWVERSION1" != "trunk" ]; then echo "Versions don't match. Exiting...."; exit 1; fi
